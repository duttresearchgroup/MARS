...
/**
       ...
       * @return double
       */
int64_t hrm_get_global_rate(heart_rate_monitor_t volatile * hb) {
...
/**
       ...
       * @return double
       */
int64_t hrm_get_windowed_rate(heart_rate_monitor_t volatile * hb) {
...
/**
       ...
       * @return double
       */
int64_t hrm_get_min_rate(heart_rate_monitor_t volatile * hb) {
...
/**
       ...
       * @return double
       */
int64_t hrm_get_max_rate(heart_rate_monitor_t volatile * hb) {
